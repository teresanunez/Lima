 ...
 *                    The [ DeleteRemainingFiles ] command IS NOT available.<br>
 ...
 *                    The [ DeleteRemainingFiles ] command IS available.<br>
*  Tango::FAULT :    Acquisition/Settings of the detector encounter a problem.<BR>
 *                    It is mandatory to fix the errors and run the command [ Init ] of the LimaDetector device.<br>
 *                    The [ Snap ] command IS NOT available.<br>
 *                    The [ Start ] command IS NOT available.<br>
 *                    The [ Stop ] command IS NOT available.<br>
 *                    The [ DeleteRemainingFiles] command IS available.<br>
 ...
 */
	string	detectorType;
/**
 *	Define the pixel depth of the detector (8, 16, 32).
 */
